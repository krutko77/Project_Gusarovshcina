...
// const inputText5 = document.getElementById("comment3");
// const nameText5 = document.getElementById("label-comment3");
// const inputText6 = document.getElementById("comment3");
// const nameText6 = document.getElementById("label-comment3");


// const foo = (input, label) => {
...
// foo(inputText5, nameText5);
// foo(inputText6, nameText6)

// Переключение на страницу благодарности после отправки формы CF7
